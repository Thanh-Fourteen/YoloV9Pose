...
class ONNX_ORT(nn.Module):
    ...
    def forward(self, x):
        ...
        selected_boxes = selected_boxes.squeeze(1)
        ...
        print('\n\ndebug: selected_boxes.shape=', selected_boxes.shape)
        print('debug: selected_categories.shape=', selected_categories.shape)
        print('debug: selected_scores.shape=', selected_scores.shape)
        print('debug: X.shape=', X.shape)
        print('debug: selected_lmks.shape=', selected_lmks.shape if self.label_kpt else 'N/A')
